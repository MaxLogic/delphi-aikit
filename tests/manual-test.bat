...
echo ============================================================
"%DAK%" analyze --project "%ROOT%\projects\DelphiAIKit.dproj" --platform Win64 --config Release --delphi 23.0 --fixinsight false --pascal-analyzer true --out "%ROOT%\_dak_pa_main" --log-file "%ROOT%\_dak_pa_main\diagnostics.log" --log-tee true
...
echo ============================================================
"%DAK%" analyze --project "%ROOT%\tests\DelphiAIKit.Tests.dproj" --platform Win64 --config Debug --delphi 23.0 --fixinsight false --pascal-analyzer true --out "%ROOT%\_dak_pa_tests" --log-file "%ROOT%\_dak_pa_tests\diagnostics.log" --log-tee true
echo Exit=%ERRORLEVEL%
...
echo ============================================================
%PALCMD% "%ROOT%\projects\DelphiAIKit.dproj" /CD11W64 /BUILD=Release /R="%ROOT%\_palcmd_test\main" /F=X /Q /A+ /FA /T=%PA_THREADS%
echo Exit=%ERRORLEVEL%

echo ============================================================
echo Direct PALCMD - tests dproj
echo ============================================================
%PALCMD% "%ROOT%\tests\DelphiAIKit.Tests.dproj" /CD11W64 /BUILD=Debug /R="%ROOT%\_palcmd_test\tests" /F=X /Q /A+ /FA /T=%PA_THREADS%
echo Exit=%ERRORLEVEL%

echo ============================================================
echo Direct PALCMD - single unit
echo ============================================================
%PALCMD% "%ROOT%\src\dak.types.pas" /CD11W64 /FM /F=X /Q /R="%ROOT%\_palcmd_test\unit"
echo Exit=%ERRORLEVEL%
