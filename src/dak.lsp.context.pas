...
uses
  ...
  DelphiSemantics.Lsp,
  Dak.FixInsightSettings, Dak.Messages, Dak.Project.BuildParams, Dak.Project.SourceLookup, Dak.Registry, Dak.RsVars, Dak.Utils;
...
begin
  ...
  try
    ...
    TFile.WriteAllText(aSettingsFilePath,
      TDelphiSemanticLspBoundary.BuildOfficialSettingsJson(lSettings), TEncoding.UTF8);
    Result := True;
  except
    on E: Exception do
    begin
