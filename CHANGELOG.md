...
- Added `lsp probe` plus `tools/lsp-capability-probe.py` to compare `contextFile` versus `settingsFile` handshakes, emit DelphiLSP capability matrices, and capture the Delphi 23 baseline for future Delphi 13 rechecks. (T-124)
