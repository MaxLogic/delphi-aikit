...
- Added `remove-with --mode plan` resolver classifications for identifiers inside single, multiple, and nested `with` statements, including unchanged, external, unsupported, unresolved, and ambiguous cases. (T-141)
